...
Easy way: run [this Colab Notebook](https://colab.research.google.com/github/ajayskabadi2012/Pedestrian-Detection-master2/blob/master/tensorflow_object_detection_training_colab.ipynb).
